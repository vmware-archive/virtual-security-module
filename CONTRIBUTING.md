...
# Contributing to virtual-security-module
...
this repository must be signed as described on that page. Your signature certifie
that you wrote the patch or have the right to pass it on as an open-source patch.

## Getting Started
Please see [HOWTO](doc/HOWTO.md).
...
``` shell
git remote add upstream https://github.com/vmware/virtual-security-module.git
